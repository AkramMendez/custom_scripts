...
# Script for mapping short-reads using HISAT2
module load bioinfo-tools
module load HISAT2/2.2.1
module load samtools


inputdir=$(realpath $1) # Input directory with trimmed raw reads
hisat2_index_basename=$(realpath $2) # HISAT2 index basename
