...
macs2 callpeak -t IP.bam -c input.bam --name=m6a --format="BAM" --gsize=2747877777 --tsize=75 --nomodel --extsize=100 --scale-to small --bdg 2> macs.out

echo "Calling negative peaks (flipping input vs IP)"

macs2 callpeak -t input.bam -c IP.bam --name=m6a_negativePeaks --format="BAM" --gsize=2747877777 --tsize=75 --nomodel --extsize=100 --scale-to small --bdg 2> macs_negativePeaks.out
...
meme bestPeaks_uniq.fa -dna -nmotifs 3 -maxsize 1000000 -maxw 5 -o bestPeaks_meme -p 8

meme bestPeaks_negativePeaks_uniq.fa -dna -nmotifs 3 -maxsize 1000000 -maxw 5 -o bestPeaks_negativePeaks_meme -p 8
...
#findMotifsGenome.pl bestPeaks.bed ${hg38} homerMotifs -size 75 -len 7 -basic -rna