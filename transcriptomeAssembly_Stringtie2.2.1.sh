...
#This scripts performs a de novo transcriptome assembly from Oxford Nanopore dRNA long-read sequencing using StringTie2
...
inputdir=$(realpath $1) #Path to input BAM files from dRNA reads mapped to T2T reference genome
